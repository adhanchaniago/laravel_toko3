...
<div id="wrapper">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Blooow Ecommerce<sup>2</sup></div>
    </a>
    ...
    <li class="nav-item">
        ...
        <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Sub Pesanan:</h6>
            <a class="collapse-item" href="{{ route('order.index') }}">List Pesanan</a>
        </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Sub Produk:</h6>
            ...
            <a class="collapse-item" href="{{ route('product.show_trash') }}">Produk Nonaktif</a>
        </div>
        </div>
    </li>
    ...
    <div id="content">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="{{ asset('uploads/dummy-photo-profile.jpg') }}">
            </a>
    ...
    <footer class="sticky-footer bg-white">
        ...
        <div class="copyright text-center my-auto">
            <span>Copyright &copy; <strong>Muhamad Ihsan Ansory</strong> 2020</span>
        </div>
        </div>
    </footer>
    <!-- End of Footer -->
...
<div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">Kami akan merindukan Anda :(</div>
