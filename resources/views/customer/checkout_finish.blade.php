    ...
    @isset($carts)
        <form action="{{ route('checkout_process') }}" method="post">
            ...
            <div class="form-group">
                ...
                <select name="province_id" id="province_id" class="form-control @error('province_id') is-invalid @enderror" required {{ old('province_id') }}>
            ...
            <div class="form-group">
                ...
                <select name="city_id" id="city_id" class="form-control @error('city_id') is-invalid @enderror" required {{ old('city_id') }}>
            ...
            <div class="form-group">
                ...
                <select name="district_id" id="district_id" class="form-control @error('district_id') is-invalid @enderror" required {{ old('district_id') }}>
